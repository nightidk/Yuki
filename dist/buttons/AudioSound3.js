...
exports.default = new Button_1.Button({
    ...
    run: async ({ client, interaction }) => {
        ...
        const resourse = (0, voice_1.createAudioResource)(`${__dirname}/../assets/audios/audio3.mp3`);
        const player = state.subscription?.player;
        player.play(resourse);
        await interaction.reply({
            ephemeral: true,
            content: `Успешное воспроизведение ГС-3`,
        });
    },
});
